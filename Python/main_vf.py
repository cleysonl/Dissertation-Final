...
# in_values_wellbeing = {"visits": 14,"mind_exercise": 30,"familyint": 25}  #BLUE
in_values_wellbeing = {"visits": 7.05/30 ,"mind_exercise": 0.5,"familyint": 13.2/30}  
in_values_health = {"med": 0.91,"p_exercise": 0.102,"temp": 0.657}
# in_values_security = {"loc": 0.5,"mob": 3,"env": 2.5}

# Reads the rules from an excel file
rulesw = pd.read_excel(r'Python\rules.xlsx', sheet_name='Wellbeing')
rulesh = pd.read_excel(r'Python\rules.xlsx', sheet_name='Health')
